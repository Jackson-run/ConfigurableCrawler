...
import ustc.sse.page.service.JdbcSqlNewsServiceImpl;
...
public class JdbcSqlServlet extends HttpServlet {
	...
	private NewsService studentService = new JdbcSqlNewsServiceImpl();
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// 接收request里的参数
		String title = request.getParameter("title"); //新闻title
		...
		if(pageNumStr !=null && !StringUtil.isNum(pageNumStr)){
			...
			request.getRequestDispatcher("jdbcSqlNews.jsp").forward(request, response);
			return;
		}
