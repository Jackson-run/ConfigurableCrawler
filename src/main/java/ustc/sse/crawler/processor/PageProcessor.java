 ...
 * 并定制化{@link #process(Response, Config, RequestScheduler, ResultModelScheduler)}方法，实现不同的页面处理逻辑
 *
 * @author wangrun
 * @version 0.1
 */
public interface PageProcessor {
     ...
     */
    public void process(Response response, Config config, RequestScheduler requestScheduler, ResultModelScheduler resultModelScheduler);
